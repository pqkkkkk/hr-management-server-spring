 ...
 * - Need full dataset for calculations (total work credits, attendance statistics)
 */
public interface TimeSheetQueryService {
     ...
     * Returns statistics like: total days worked, total late days, total overtime minutes, etc.
     * @param employeeId Employee ID
     * @param yearMonth Year and month
