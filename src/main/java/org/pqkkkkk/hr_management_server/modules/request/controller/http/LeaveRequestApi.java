 ...
 * Provides endpoints for creating, approving, rejecting, and querying leave requests.
 */
@RestController
...
public class LeaveRequestApi {
     ...
     * 
     * @param employeeId - the ID of the employee (should come from authenticated user)
     ...
     * 
     * @param approverId - the ID of the approver/manager (should come from authenticated user)
     * @param filter - additional filter criteria
