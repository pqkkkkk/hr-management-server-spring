...
/**
 * REST API controller for Timesheet Request management (V2).
 * Provides enhanced endpoints supporting:
 * - Status updates (PRESENT/LEAVE for morning/afternoon)
 * - WFH flag updates
 * - Optional check-in/check-out time corrections
 */
@RestController
@RequestMapping("/api/v2/requests/timesheet")
public class TimeSheetRequestApiV2 {

    private final RequestCommandService timeSheetRequestCommandService;
    private final RequestQueryService requestQueryService;

    public TimeSheetRequestApiV2(
    ...
    /**
     * GET /api/v2/requests/timesheet/{requestId}
    ...
    /**
     * POST /api/v2/requests/timesheet
     * Create an extended timesheet correction request with support for:
     * - Status changes (morning/afternoon PRESENT or LEAVE)
     * - WFH flag settings
     * - Optional check-in/check-out time corrections
     * 
     * @param request - the extended timesheet request data
    ...
    public ResponseEntity<ApiResponse<TimeSheetRequestDTO>> createTimeSheetRequest(
        ...
        // Convert DTO to entity (includes extended fields)
        ...
        ApiResponse<TimeSheetRequestDTO> apiResponse = new ApiResponse<>(
                ...
                "Extended timesheet request created successfully.",
                null);
